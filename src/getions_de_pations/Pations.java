...
public class Pations {
   ...
   private final StringProperty Actions;
    ...
    public Pations(String Id, String Nome, String Prenom, String Date_nai, String Date_ajouter, String Tlephone, String Sexe, String Adresse) {
   ...
   /*public String getActes() {
    ...
    public StringProperty SexePreperty() {
        return Sexe;
    }
